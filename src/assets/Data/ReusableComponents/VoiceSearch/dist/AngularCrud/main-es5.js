...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _search_data_search_data_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./search-data/search-data.component */
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      directives: [_search_data_search_data_component__WEBPACK_IMPORTED_MODULE_1__["SearchDataComponent"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _speech_recognition_speech_recognition_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./speech-recognition/speech-recognition.component */
    "./src/app/speech-recognition/speech-recognition.component.ts");
    /* harmony import */


    var _search_data_search_data_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./search-data/search-data.component */
    "./src/app/search-data/search-data.component.ts");
    /* harmony import */
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_2__["BrowserAnimationsModule"], ng2_search_filter__WEBPACK_IMPORTED_MODULE_7__["Ng2SearchPipeModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _speech_recognition_speech_recognition_component__WEBPACK_IMPORTED_MODULE_5__["SpeechRecognitionComponent"], _search_data_search_data_component__WEBPACK_IMPORTED_MODULE_6__["SearchDataComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_2__["BrowserAnimationsModule"], ng2_search_filter__WEBPACK_IMPORTED_MODULE_7__["Ng2SearchPipeModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppSearchDataSearchDataComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SearchDataComponent", function () {
    ...
    var _speech_recognition_speech_recognition_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../speech-recognition/speech-recognition.component */
    "./src/app/speech-recognition/speech-recognition.component.ts");
    /* harmony import */
    ...
    function SearchDataComponent_div_1_tr_11_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function SearchDataComponent_div_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function SearchDataComponent_div_2_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 2);
    ...
    var SearchDataComponent =
    /*#__PURE__*/
    function () {
      function SearchDataComponent(_ngZone) {
        _classCallCheck(this, SearchDataComponent);
      ...
      _createClass(SearchDataComponent, [{
        key: "ngOnInit",
        ...
        key: "returnText",
        value: function returnText(value) {
          var _this = this;
        ...
        value: function updateData(text) {
          if (text) {
            ...
            this.filteredData = this.userData.filter(function (obj) {
    ...
    SearchDataComponent.ɵfac = function SearchDataComponent_Factory(t) {
      return new (t || SearchDataComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgZone"]));
    };

    SearchDataComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: SearchDataComponent,
      selectors: [["app-search-data"]],
      decls: 3,
      vars: 2,
      consts: [[3, "searchTextEmitter", "resetData"], ["class", "m-auto w-75 p-2", 4, "ngIf"], [1, "m-auto", "w-75", "p-2"], [1, "table"], ["scope", "col"], [4, "ngFor", "ngForOf"]],
      template: function SearchDataComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "app-speech-recognition", 0);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("searchTextEmitter", function SearchDataComponent_Template_app_speech_recognition_searchTextEmitter_0_listener($event) {
            return ctx.returnText($event);
          })("resetData", function SearchDataComponent_Template_app_speech_recognition_resetData_0_listener() {
      ...
      directives: [_speech_recognition_speech_recognition_component__WEBPACK_IMPORTED_MODULE_1__["SpeechRecognitionComponent"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["NgIf"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["NgForOf"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SearchDataComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppSpeechRecognitionSpeechRecognitionComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var SpeechRecognitionComponent =
    /*#__PURE__*/
    function () {
      ...
      _createClass(SpeechRecognitionComponent, [{
        ...
        value: function ngOnInit() {
          if ('webkitSpeechRecognition' in window) {
            ...
            console.log("not supported"); // speech recognition API not supported
          }
        }
      }, {
        key: "voiceSearch",
        value: function voiceSearch() {
          var _this2 = this;
          ...
          recognition.onresult = function (event) {
            _this2.speechToText = event.results[0][0].transcript;
            document.getElementById('textToSearch').value = _this2.speechToText;

            if (_this2.speechToText) {
              _this2.emitSearchValue();
            }
          };
        ...
        key: "emitSearchValue",
        value: function emitSearchValue() {
    ...
    SpeechRecognitionComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 5,
      vars: 1,
      consts: [[1, "container"], [1, "m-auto"], ["type", "text", "id", "textToSearch", "placeholder", "Click on the microphone icon and begin speaking.", 1, "w-100", "p-2", 3, "readonly"], ["type", "image", "alt", "Start", "id", "image", "src", "assets/mic.gif", 3, "click"]],
      template: function SpeechRecognitionComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SpeechRecognitionComponent_Template_input_click_3_listener() {
            return ctx.voiceSearch();
          });
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\10668058\Desktop\Voice Search application\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
